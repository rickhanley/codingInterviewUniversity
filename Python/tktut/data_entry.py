...
ttk.Label(root, text="ABQ Data Entry Application",
...
for lab in ('A', 'B', 'C'):
    ttk.Radiobutton(labframe, value=lab, text=lab, variable=variables['Lab']
...
e_info = ttk.LabelFrame(drf, text="Environemnt Data")
...
ttk.Spinbox(
    ...
    from_=0.5, to=52, increment=0.01,
).grid(row=1, column=0, sticky=(tk.W + tk.E))
